...
## 2. 推奨技術スタック
契約本文解析とプロセス統合の両立が必要。Backend は TypeScript/NestJS、条項抽出・比較補助は Python、ワークフローは Temporal、RDB は PostgreSQL、全文検索は OpenSearch。外部署名連携に DocuSign/Adobe Sign、権限管理は ABAC を推奨。
